package com.facishare.wechat.access.client.codec;
 ...
 */
public class JsonEncoder extends MessageToByteEncoder<TransData> {
	/**
	 * 日志对象
	 */
	...
	@Override
	protected void encode(ChannelHandlerContext ctx, TransData msg, ByteBuf out)
			throws Exception {

		byte[] bytes = msg.toJson().getBytes("UTF-8");// 将对象转换为byte
