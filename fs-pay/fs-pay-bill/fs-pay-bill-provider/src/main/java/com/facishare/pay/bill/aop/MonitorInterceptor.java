package com.facishare.pay.bill.aop;
...
public class MonitorInterceptor implements MethodInterceptor {
    ...
    private static final String MONITOR_KEY_PRE = "pay.bill.";
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        ...
        logger.info("method :{} cost {} result : {} ", invocation.getMethod().getName(),  (System.currentTimeMillis()-startTime), result);
        // 监控开关
        if (!MONITOR_RUNNING) {
            return result;
        }
